...
async def get_closing_message(sender: str, anthropic_api_key: str, reason: str = "farewell") -> str:
    ...
    if reason == "deferred":
        ...
        system = (
            "אתה נציג מכירות ידידותי של דלתות מיכאל. "
            "הלקוח ציין שמישהו יגיע לאולם התצוגה, או שהכל מסודר. "
            "כתוב הודעה קצרה (1–2 שורות) חמה ומסכמת. "
            "כלול תמיד המלצה לתאם מראש כי לא תמיד יש נציג באולם — "
            "לדוגמה: 'נתראה בקרוב 😊 רק לציין — מומלץ לתאם שעת הגעה מראש כדי שנציג יהיה שם'. "
