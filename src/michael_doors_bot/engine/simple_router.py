...
_SCENARIOS: dict[str, dict] = {
    ...
    "showroom_address": {
        ...
        "response": (
            ...
            "מומלץ לתאם פגישת ייעוץ מראש — רוצה שאקבע לך זמן?"
        ),
    },
    "showroom_hours": {
        "handoff_to_human": False, "needs_frame_removal": None,
    ...
    "mamad": {
        ...
        "response": (
            "היי, תודה שפניתם לדלתות מיכאל.\n"
            "שמחה לעזור! האם מדובר בממ\"ד חדש, או שיש ממ\"ד קיים שרוצה להחליף את דלתו?"
        ),
    },
    "frame_removal": {
        "handoff_to_human": False, "needs_frame_removal": None,
        ...
        "response": (
            "היי, תודה שפניתם לדלתות מיכאל.\n"
            "אשמח להבין האם מדובר בדלת כניסה או דלת פנים, כדי שנוכל לכוון אותך נכון."
        ),
    },
    "designed_doors": {
        "handoff_to_human": False, "needs_frame_removal": None,
        ...
        "response": (
            ...
            "אשמח להבין האם את מתעניינת בדלת כניסה או דלת פנים, כדי שנוכל לכוון אותך נכון."
        ),
    },
    "detailed_inquiry": {
        "handoff_to_human": False, "needs_frame_removal": None,
    ...
    "detailed_inquiry_interior": {
        ...
        "response": (
            "היי, תודה שפניתם לדלתות מיכאל.\n"
            "כדי שנוכל להכין לך הצעת מחיר מדויקת — האם מדובר בהחלפה של דלתות פנים קיימות, בית בשיפוץ, או בית חדש ללא דלתות פנים כרגע?"
        ),
    },
    "entrance_doors": {
        "handoff_to_human": False, "needs_frame_removal": None,
        ...
        "response": (
            ...
            "את מחפשת דלת כניסה מודרנית, קלאסית או מעוצבת?"
        ),
    },
    "interior_doors": {
        "handoff_to_human": False, "needs_frame_removal": None,
    ...
    "vague_inquiry": {
        ...
        "response": (
            "היי, תודה שפניתם לדלתות מיכאל.\n"
            "בכיף! כדי שנוכל לתת לך הצעת מחיר מסודרת, אשמח לדעת במה את מתעניינת — "
    ...
    "ambiguous": {
        ...
        "response": (
            "היי, תודה שפניתם לדלתות מיכאל.\n"
            "אשמח להבין האם את מתעניינת בדלת כניסה או דלת פנים, כדי שנוכל לכוון אותך נכון.\n"
            "אחרי שתכתבי את הפרט הזה, נמשיך יחד בצורה מסודרת."
        ),
    },
}
